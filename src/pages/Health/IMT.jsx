      ...
      <div className={"container"}>
        <div className={"mb-5"}>
          ...
          <p>
            ...
            необходимо
            выбрать в представленном сервисе свой рост и вес.
          </p>
          <p>
            ...
            остается
            в пределах 18-22, живут в среднем дольше, чем те, у кого есть проблемы с весом.
          </p>
          <p>
          ...
          <p>
            ...
            остро.
            В самом начале расчет имт разрабатывался для социологических исследования, поэтому ставить медицинский
            диагноз
            с помощью этих расчетов не совсем правильно.
          </p>
          <p>
            Однако доступность и простота расчета сделала данный калькулятор очень популярным среди населения. Если
            индекс
            превышает число 30, то это с большой долей вероятности говорит об ожирении.
          </p>
          <p>
        ...
        <div className={"mb-5"}>
          ...
          <p>Для того, чтобы узнать свой ИМТ необходимо лишь свой вес в килограммах разделить на квадрат роста в
            метрах.</p>
          <p className={"text-center p-4 text-uppercase border border-3 border-warning rounded bg-white-yellow"}>ИМТ =
            вес/рост<sup>2</sup></p>
          <p>Формула не учитывает пол и возраст человека, несмотря на то что ИМТ мужчин выше чем ИМТ женщин, а также ИМТ
            выше у людей среднего возраста, а у детей и пожилых людей этот показатель ниже.</p>
        </div>
        <div className={"mb-5"}>
          <h3>Сводная таблица значений</h3>
          <p>Интерпретация показателей ИМТ, в соответствии с ремомендациями Всемирной Организации Здравоохранения
            (ВОЗ)</p>
