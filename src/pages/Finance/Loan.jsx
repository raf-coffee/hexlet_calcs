          ...
          <div className={"col-sm mb-5"}>
            ...
            <Form>
              <Form.Group className={"mb-4 row"} controlId={"variants"}>
                ...
                <div className={"col-8"}>
                  <Form.Select aria-label="Вариант расчета">
                    <option value="monthy">Расчёт ежемесячного платежа</option>
              ...
              <Form.Group className={"mb-4 row"} controlId={"monthyPay"}>
                <div className={"col-4 text-nowrap"}>
      ...
      <div>
        ...
        <div className={"border border-3 border-success-subtle p-3 mb-4"}>
          ...
          <ul>
            ...
            <li>
              <span
                className={"fw-bold"}>Вычисление срока кредита на основе заданной суммы и ежемесячного платежа</span> -
            ...
            <li>
              <span
                className={"fw-bold"}>Расчет максимальной суммы кредита по заданному сроку и ежемесячному платежу</span> -
              если вы точно знаете, какую сумму и в течение какого времени вы готовы отдавать каждый месяц на погашение
              кредита, калькулятор сообщит вам, сколько денег вы сможете занять на таких условиях.
            </li>
          </ul>
        </div>
        <p>
        ...
        <p className={"fw-bold"}>Кредитный калькулятор - это удобный инструмент для быстрого самостоятельного расчета
          кредита онлайн.</p>
        <p className={"mb-5"}>
        ...
        <div className={"mb-5 text-start"}>
          ...
          <ol>
            <li>
              ...
              по ставке, равной ключевой,
              накидывает еще несколько процентов сверху и дает вам в долг под более высокий процент, зарабатывая на
              разнице. Выгоднее брать кредит, когда ключевая ставка ниже: вы заплатите меньше процентов. На каждом
              очередном заседании ЦБ может как повысить, так и понизить ставку или оставить без изменений. Это решение
              принимается в зависимости от экономической ситуации.
        ...
        <div className={"mb-5 text-start"}>
          ...
          <p>Что такое аннуитетный и дифференцированный платеж? В чем разница между ними? Какой из них выгоднее для
            заемщика?</p>
          <div className={"container text-center"}>
            <div className={"row justify-content-evenly"}>
              <div className={"col-5 border border-2 border-secondary-subtle p-3"}>
                ...
                <p className={"border-bottom border-2 border-secondary p-2"}>Доля процентов и доля основного долга в каждом месяце рассчитываются таким образом, чтобы общая сумма
                  была неизменной.</p>
                <p className={"border-bottom border-2 border-secondary p-2"}>Аннуитетный платеж более распространен за счет удобства выплаты. Платить каждый месяц одну и ту же
                  сумму логичнее и проще для учета финансов.</p>
                <p className={"border-bottom border-2 border-secondary p-2"}>Переплата по кредиту выше, чем при дифференцированном платеже.</p>
              </div>
              <div className={"col-5 border border-2 border-secondary-subtle p-3"}>
                ...
                <p className={"border-bottom border-2 border-secondary p-2"}>Доля основного долга остается неизменной, а доля процентов с каждым месяцем уменьшается, так как
                  уменьшается общая сумма долга.</p>
                <p className={"border-bottom border-2 border-secondary p-2"}>Ежемесячные платежи вначале срока выше по сравнению с аннуитетом, поэтому выше требования к
                  платежеспоособности клиента.</p>
                <p className={"border-bottom border-2 border-secondary p-2"}>Дифференцированный платеж выгоднее, сумма переплаты ниже.</p>
              </div>
            </div>
          </div>
        </div>
