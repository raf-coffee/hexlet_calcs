    ...
    <div>
      <div className={"container text-start"}>
          ...
          <div className={"col-sm mb-5"}>
            ...
            <Form>
              <Form.Group key={"nds-checkbox"} controlId={"pays"} className={"mb-4 row d-flex justify-content-end"}>
                <div className={"col-7"}>
                  <Form.Check name={"before"} value={"before"} type={"radio"}
                              label={"Известна сумма до налогообложения"}
                              id={"ndfl-checkbox-1"}
                              checked={checked === "before"} onClick={handleCheckboxToggle}/>
                  <Form.Check name={"after"} value={"after"} type={"radio"}
                              label={"Известна сумма после налогообложения"}
                              id={"ndfl-checkbox-2"}
                              checked={checked === "after"} onClick={handleCheckboxToggle}/>
                </div>
              </Form.Group>
        ...
        <div className={"border border-3 border-success-subtle p-3 mb-4"}>
          ...
          <ul>
            <li>Расчет НДФЛ и суммы после налогообложения при известном значении дохода. Например, вы получили доход и
              вам необходимо рассчитать налог, а также сумму, которая у вас останется после уплаты налога.
            </li>
            <li>Вычисление НДФЛ и суммы дохода при известном значении суммы, оставшейся после налогообложения. Например,
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              автоматически удерживает с неё подоходный налог - 13%.
              Работодатель является здесь вашим налоговым агентом, и у вас нет необходимости заботиться об уплате НДФЛ и
              подаче декларации, т.к. работодатель делает это за вас.
            </li>
            <li>
        ...
        <div className={"border border-4 border-success-subtle rounded-4 p-3 d-flex align-items-center justify-content-center fw-bold"}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
               className="bi bi-exclamation-circle-fill text-success me-2" width="32" height="30" viewBox="0 0 16 16">
            <path
