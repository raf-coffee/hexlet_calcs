...
export const imt = (height, weight) => {
  ...
  const range = {
    1: () => (exp <= 15.99 ? rows[1] : false),
    2: () => (exp >= 16 && exp <= 18.49 ? rows[2] : false),
    3: () => (exp >= 18.50 && exp <= 24.99 ? rows[3] : false),
    4: () => (exp >= 25 && exp <= 29.99 ? rows[4] : false),
    5: () => (exp >= 30 && exp <= 34.99 ? rows[5] : false),
    6: () => (exp >= 35 && exp <= 39.99 ? rows[6] : false),
    7: () => (exp >= 40 ? rows[7] : false),
  };
